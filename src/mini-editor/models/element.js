// import { parsePx } from '../../../../../../luban-h5/front-end/h5/src/utils/element.js'
function parsePx (px) {
  return `${px}px`
}
...
class Element {
  constructor (ele) {
     ...
     */
    this.pluginProps = (typeof ele.pluginProps === 'object' && cloneObj(ele.pluginProps)) || this.getDefaultPluginProps(ele.props || {})
